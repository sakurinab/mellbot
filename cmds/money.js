...
module.exports.run = async (bot,message,args) => {
	try{
		...
		.setDescription(`• Для выполнения этой команды вам нужны следующие роли: <@&${config.ownerRole}>`)
		.addField(`Использование команды`,`${config.prefix}money take/give <target> <amount>`)
